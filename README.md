...
# birthday
This is a example project with react-native-cli, implements a login with validations and a calendar, which alerts when we are close to the configured dates.
